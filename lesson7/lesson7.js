...
function init() {
    ...
    */
    ...
    document.getElementById('count').innerHTML = 'Ваш счет: ' + score;
...
function move() {
    ...
    } else if (!isSnakeUnit(new_unit)&& !haveBlock(new_unit)) {
